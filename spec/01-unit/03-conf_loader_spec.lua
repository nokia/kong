...
describe("Configuration loader", function()
  it("loads the defaults", function()
    ...
    assert.same({"127.0.0.1:8001", "127.0.0.1:8444 ssl", "[::1]:8001", "[::1]:8444 ssl"}, conf.admin_listen)
    assert.same({"0.0.0.0:8000", "0.0.0.0:8443 ssl", "[::]:8000", "[::]:8443 ssl"}, conf.proxy_listen)
